...
use super::ng::get_ng_caniot_controller_server;
use crate::{
    grpcserver::{legacy::get_legacy_caniot_controller, ng::get_ng_devices_server},
    shared::SharedHandle,
};
...
pub async fn grpc_server(shared: SharedHandle) -> Result<(), GrpcServerInitError> {
    ...
    let ng_controller = get_ng_caniot_controller_server(shared.clone());
